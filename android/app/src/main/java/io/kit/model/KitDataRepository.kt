...
import io.kit.api.KitApi.Companion.DATE_FORMAT
import io.kit.*
...
class KitDataRepository(private val context: Context) : AnkoLogger {
    ...
    private val kotlinConfApi: KitApi by lazy {
        KitApi.create(userId)
    }
